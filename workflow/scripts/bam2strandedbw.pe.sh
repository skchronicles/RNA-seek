...
#converts STAR aligned PE bam file to forward and reverse strand bigwigs
...
bedGraphToBigWig ${bam}.fwd.bg ${bam}.genome ${bam%%.*}.fwd.bw
bedSort ${bam}.rev.bg ${bam}.rev.bg 
bedGraphToBigWig ${bam}.rev.bg ${bam}.genome ${bam%%.*}.rev.bw
